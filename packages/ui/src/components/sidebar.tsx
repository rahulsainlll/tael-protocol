...
>(
  (
    ...
    // Internal state; controllable via `open`/`onOpenChange`.
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // Persist so the server can render at the right width on next load.
  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Reserves the layout gap the fixed sidebar occupies. */}
        <div
          className={cn(
...
>(({ className, showIcon = false, ...props }, ref) => {
  // Random width between 50% and 90% so skeleton rows look natural.
