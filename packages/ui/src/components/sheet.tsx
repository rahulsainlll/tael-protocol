...
// A Sheet is a Radix Dialog anchored to an edge — same primitive as Dialog, so
// it adds no new dependency. We use it for the mobile navigation drawer.
...
interface SheetContentProps
  ...
  /** Hide the built-in close button (e.g. when the content owns its own). */
  hideClose?: boolean;
}
