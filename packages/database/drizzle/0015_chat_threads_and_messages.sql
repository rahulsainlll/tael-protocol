...
CREATE INDEX "chat_threads_owner_id_idx" ON "chat_threads" USING btree ("owner_id","updated_at");--> statement-breakpoint
CREATE INDEX "chat_messages_thread_id_idx" ON "chat_messages" USING btree ("thread_id","created_at");
