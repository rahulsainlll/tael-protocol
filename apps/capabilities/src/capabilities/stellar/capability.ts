...
export const meta: CapabilityMeta = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "The chain reads (balance, account, transaction, asset, status, orderbook, trades, payments, claimable) are free. Quote, explain, and portfolio are priced per call because they aggregate or interpret data.",
    },
  ],
};
